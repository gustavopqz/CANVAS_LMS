...
if(url.match('gruponobre') && url.match('beta')){
    var homeURL = 'https://gruponobre.beta.instructure.com/'
    var apiSelf = 'https://gruponobre.beta.instructure.com/api/v1/users/self'
    var apiEnrollments = 'https://gruponobre.beta.instructure.com/api/v1/users/self/enrollments'
    var conversations = 'https://gruponobre.beta.instructure.com/api/v1/conversations'
}else if (url.match('gruponobre')){
    var homeURL = 'https://gruponobre.instructure.com/'
    var apiSelf = 'https://gruponobre.instructure.com/api/v1/users/self'
    var apiEnrollments = 'https://gruponobre.instructure.com/api/v1/users/self/enrollments'
    var conversations = 'https://gruponobre.instructure.com/api/v1/conversations'
}else if(url.match('unef') && url.match('beta')){
    var homeURL = 'https://unef.beta.instructure.com/'
    var apiSelf = 'https://unef.beta.instructure.com/api/v1/users/self'
    var apiEnrollments = 'https://unef.beta.instructure.com/api/v1/users/self/enrollments'
    var conversations = 'https://unef.beta.instructure.com/api/v1/conversations'
}
else{
    var homeURL = 'https://unef.instructure.com/'
    var apiSelf = 'https://unef.instructure.com/api/v1/users/self'
    var apiEnrollments = 'https://unef.instructure.com/api/v1/users/self/enrollments'
    var conversations = 'https://unef.instructure.com/api/v1/conversations'
}
...
const admGlobal = [180, 175, 718, 193, 188, 686]
...
if (url == homeURL || url.match(/success/)){
    ...
    documentTitle[0].innerText = 'UNEF - Canvas'
    // ----------------------------------------------------------------------------------------------------------------------------
    ...
    `<div id="topLogo" class="headerDiv"> 
        <a href="${homeURL}"><img id="logoUNEF" src="https://gruponobre.instructure.com/users/180/files/1164/preview?verifier=p6HZobxT0AiEBv1EfAVdqo2jBN7wS3HHmqC0nTzw" alt="logo" width="180px"/></a>
    </div>
    <div class="headerDiv">
        <h2 id="centro"></h2>
    </div>
    <div class="headerDiv">
        <lu id="navMenu">
            <li class="navIcon"><a href="${homeURL}profile/qr_mobile_login"><img id="1478" class="navIconInside" src="https://gruponobre.instructure.com/users/180/files/2379/preview?verifier=6tI4T7XC0iWOAqAS2VgEkOss4AstFCZaFoaBedEK" alt="QR CODE.png" width="30"/><p style= "color: white;">QR</p></a></li>
            <li class="navIcon"><a href="${homeURL}profile"><img id="1287" class="navIconInside" src="https://gruponobre.instructure.com/users/180/files/2378/preview?verifier=zYELcaUvnbu7otePctS7JzBFhmugz3XdrMrX1e8r" alt="user-top.png" width="30"/><p style= "color: white;">Perfil</p></a></li>
            <li class="navIcon"><a href="${homeURL}logout"><img id="1294" class="navIconInside" src="https://gruponobre.instructure.com/users/180/files/2377/preview?verifier=XiqMiwInyXsT8PXMQskq3UBBK75N4Q9TNGkBS2nJ" alt="sing-out-top.png" width="30"/><p style= "color: white;">Sair</p></a></li>
            <li class="navIcon"><a href="${homeURL}"><img id="1289" class="navIconInside" src="https://gruponobre.instructure.com/users/180/files/2380/preview?verifier=0V6Rj9HDyRDmD5wIpOLfXfc5WcIOowIVW4v6RUbN" alt="home-top.png" width="30"/><p style= "color: white;">Início</p></a></li>
        </lu>
    </div>`
    ...
    `<h2 id="shortcutsTitle">LINKS RÁPIDOS</h2>
        <div id="divCards">
            <div class="card">
                <h3>DISCIPLINAS</h3>
                <img id="2352" src="https://gruponobre.instructure.com/users/180/files/2352/preview?verifier=g3TBonPVHDFCzsp74xtgHpi7K2jwMkk5qKNFRYzI" alt="disciplinas.png"/>
                <button onClick="window.location.href='${homeURL}courses'">Acessar</button></a>
            </div>
            <div class="card">
                <h3>CHAT TÉCNICO</h3>
                <img id="1241" src="https://gruponobre.instructure.com/users/180/files/1241/preview?verifier=wVoA5i8aMyVx6e0BuYaxW2GKezTczwE4WHhYUpPo" alt="chat tecnico.png"/>
                <button onClick="chatTecnico()">Acessar</button></a>
            </div>
            <div class="card">
                <h3>CALENDÁRIO</h3>
                <img id="1200" src="https://gruponobre.instructure.com/users/180/files/1200/preview?verifier=CLY3hme6iERUbC0pFRxUmJVvCgUXYtk99YIzLtA6" alt="calendar-faixa.png"/>
                <a href="${homeURL}calendar"><button>Acessar</button></a>
            </div>
            <div class="card">
                <h3>MEU DRIVE</h3>
                <img id="1196" src="https://gruponobre.instructure.com/users/180/files/1196/preview?verifier=aS1fL7ixcPuKUzPmvsTli7zXrelOOMlumAFsMgTl" alt="box-faixa.png"/>
...
//DEMAIS PÁGINAS
    ...
    divNewHeader.innerHTML = 
    `<div id="topLogo" class="headerDiv"> 
        <a href="${homeURL}"><img id="1164" src="https://gruponobre.instructure.com/users/180/files/1164/preview?verifier=p6HZobxT0AiEBv1EfAVdqo2jBN7wS3HHmqC0nTzw" alt="UNEF.png" width="180px"/></a>
    </div>
    <div class="headerDiv">
        <h2 id="centro"></h2>
    </div>
...
if (url.match(/courses/) && url.length == courseLength){
    ...
    async function userVerification(){
        ...
        if (admGlobal.indexOf(data.id) != -1){
...
if(url.match('modules') && url.length == courseLength + 8){
    ...
    for(i=0;i<modulesIcons.length;i++){
        if(modulesIcons[i].attributes['title'].value == 'Página'){
            modulesIcons[i].children[1].innerHTML = '<img id="1822" src="https://gruponobre.instructure.com/users/180/files/2385/preview?verifier=w5vZ0ArXfIFGcY5g2HFaUkg0hG2JJhoxrTlVjO7r" alt="webpage2" />'
        }else if(modulesIcons[i].attributes['title'].value == 'URL externa'){
            modulesIcons[i].children[1].innerHTML = '<img id="1820" src="https://gruponobre.instructure.com/users/180/files/2383/preview?verifier=g15lzzZX0JPAsAztxZHSfCBFUpS6hKiPPTPktX85" alt="videoaula" />'
        }else if(modulesIcons[i].attributes['title'].value == 'Anexo'){
            modulesIcons[i].children[1].innerHTML = '<img id="1815" src="https://gruponobre.instructure.com/users/180/files/2382/preview?verifier=IP37MA6llBMQKBsH9J6Q2wUJaM7I5GQvKmOowEda" alt="book" />'
        }else if(modulesIcons[i].attributes['title'].value == 'Subcabeçalho do módulo de contexto'){
            modulesIcons[i].children[1].innerHTML = '<img id="1823" src="https://gruponobre.instructure.com/users/180/files/2384/preview?verifier=OQh5C32sbnd9izAl470BQ8lBzJwsjP8I9RdpupLr" alt="playlist" />'
...
async function minhaBiblioteca(){
    ...
    let response = await fetch(`https://gruponobre.netlify.app/.netlify/functions/bibli_unef`, {
        method: 'post',
        body: JSON.stringify({
            firstName: firstName,
            lastName: lastName,
